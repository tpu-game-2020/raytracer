...
Vector3 RayTracing(const Vector3 pos, const Vector3 dir, int depth = 0, float index = 1.0f)
{
	...
	Sphere obj[] = {
		...
		{{ -1.0f,    1.5f,    -1.0f},     0.5f, {{0.90f, 0.00f, 0.00f}, 0.02f,0.0f} },// 空中の球(赤)
		{{ 2.0f,    0.7f,   -1.0f},     0.5f, {{0.02f, 0.10f, 0.10f}, 0.02f,0.93f, 2.4f} },// 空中の球(屈折)
		{{-2.0f,    0.5f,   -1.0f},     0.5f, {{0.00f, 0.00f, 0.50f}, 0.95f,0.0f} },// 空中の球(反射)
		{{ 0.0f, -100000.0f, 0.0f}, 100000.f, {{0.20f, 0.70f, 0.20f}, 0.0f, 0.0f} },// 地面
		{{1000.0f, 10000.0f,500.0f},  1000.f, {{1000.f,690.0f,680.0f},0.0f, 0.0f} },// 太陽
	};
