...
Vector3 RayTracing(const Vector3 pos, const Vector3 dir, int depth = 0, float index = 1.0f)
{
	...
	Sphere obj[] = {
		...
		{{ 0.0f,    0.7f,    1.5f},     0.5f, {{0.00f, 1.00f, 0.00f}, 0.02f,0.0f} },// 空中の球(緑)
		{{ 1.5f,    1.0f,   -1.0f},     0.5f, {{0.02f, 0.50f, 0.30f}, 0.02f,0.5f, 4.4f} },// 空中の球(屈折)
		{{-2.0f,    0.5f,   -1.5f},     0.5f, {{0.00f, 0.00f, 0.00f}, 0.55f,0.0f} },// 空中の球(反射)
