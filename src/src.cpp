...
{
	Vector3 col = { 0.50f,0.70f, 0.50f };// 何も衝突しないときは空な色
	...
	Sphere obj[] = {
		...
		{{ 0.0f,    0.5f,    1.0f},     0.5f, {{1.00f, 0.00f, 0.00f}, 0.3f,0.85f} },// 空中の球(赤)
		{{ 2.0f,    0.5f,   -1.0f},     0.5f, {{0.02f, 0.80f, 0.10f}, 0.0f,0.93f, 2.4f} },// 空中の球(屈折)
		{{-2.0f,    0.5f,   -1.0f},     0.5f, {{0.00f, 0.00f, 0.00f}, 0.5f,0.0f} },// 空中の球(反射)
		{{ 0.0f, -100000.0f, 0.0f}, 100000.f, {{0.76f, 0.64f, 0.44f}, 0.3f, 0.0f} },// 地面
